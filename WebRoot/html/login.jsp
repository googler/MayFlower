...
<html>
<head>
    <title>MayFlower - Login</title>
    <link rel="Shortcut Icon"
        href="${contextPath}/images/paladin_red.ico" />
    <link rel="Bookmark"
        href="${contextPath}/images/paladin_red.ico" />
    <link href="${contextPath}/css/border.css"
        ...
        <tr>
            <td valign="top" class="border_bottom_green" >
                <TABLE width="95%" border=0 align="center" cellPadding='5'>
                    ...
                    alt="登录 MayFlower 帐户给您带来个性化的 MayFlower 体验。" title="登录 MayFlower 帐户给您带来个性化的 MayFlower 体验。"><BR>
                                    ...
                                    border=0>
                                        ...
                                        <tr class=enabled id=password-row>
                                          <td height="25" align=right noWrap>密码：</td>
                                            <td height="25" align="left">
                                                <input class="val" id="pwd" type="password" size="22" name="pwd" value="${user.password}">
                                            </td>
                                        </tr>
                                        <!--<tr>
