...
public class MemoryIndex implements Serializable {
  ...
  /** Could be made configurable; See {@link org.apache.lucene.document.Document#setBoost(float)} */
   ...
   * {@link #addField(String, org.apache.lucene.analysis.TokenStream)}, perhaps wrapped into another
   ...
   * {@link #keywordTokenStream(java.util.Collection)}, the Lucene contrib <code>KeywordTokenizer</code> or similar utilities.
   * 
   * @param fieldName
   *            a name to be associated with the text
   * @param stream
